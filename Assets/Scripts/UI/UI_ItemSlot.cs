    ...
    
{
    ...
    public void UpdateSlot(Inventory_Item item)
    {
        ...
        Debug.Log("itemData: " + itemInSlot.itemData);
        Debug.Log("itemIcon: " + itemInSlot.itemData?.itemIcon);
        itemIcon.sprite = itemInSlot.itemData.itemIcon;

        itemStackSize.text = itemInSlot.stackSize > 1
            ? itemInSlot.stackSize.ToString()
            : "";
    }

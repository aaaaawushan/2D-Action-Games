...
public class Skill_Shard : Skill_Base//决策者，决定"什么时候用、怎么用"
{
    ...
    [SerializeField] private float shardExitDuration = 10;
    ...
    {
        if (updateType == SkillUpgradeType.None)
            return;

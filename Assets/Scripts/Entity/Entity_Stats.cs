...
public class Entity_Stats : MonoBehaviour
{
    ...
    public State_ResourceGroup resources;
    ...
    public float GetPhysicalDamage(out bool isCrit,float scaleFactor)
    {
    ...
    {
        float basHp = resources.maxHealth.GetValue();
        float bonusHP = major.vitality.GetValue() * 5;
        return basHp + bonusHP;
    }
    ...
    public float GetEvasion()
    {
        ...
        float bonusEvasion = major.agility.GetValue() * .5f; // each agility point gives you 0.5f of evasion
